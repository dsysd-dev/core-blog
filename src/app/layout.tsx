...
export default function RootLayout({
  ...
  //       />
  //       <Link href={`/`}>
  //         <h1 className="text-2xl text-white font-bold mt-4">{siteConfig.name}</h1>
  //       </Link>
  //       <p className="text-slate-300">
  //         Awesome resources and blogs on Golang, Distributed Systems, devops,
  //         Blockchain, Solidity and Rust
  //       </p>
  //     </div>
  //   </header>
  // );
  ...
  return (
    <html lang="en">
      <body className={`bg-slate-100 ${inter.className}`}>
        {/* <div className="flex items-center h-[100svh]"> */}
        {/* <SideNav /> */}
